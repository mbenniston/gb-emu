...
#define PPU_MODE_LINE_DURATION_DOTS                                            \
  (PPU_MODE_HBLANK_DURATION_DOTS + PPU_MODE_DRAWING_PIXELS_DURATION_DOTS +     \
   PPU_MODE_OAM_SCAN_DURATION_DOTS)
...
void ppu_tick(ppu_t *ppu, lcd_t *lcd, struct bus *bus,
