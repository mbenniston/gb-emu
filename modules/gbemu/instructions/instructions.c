...
void instructions_init() {
  instructions[0x00] = (instruction_t){"NOP", instruction_nop};
  instructions[0x01] = (instruction_t){"LD BC, n16", instruction_ld_bc_n16};
  instructions[0x02] = (instruction_t){"LD (BC), A", instruction_ld_deref_bc_a};
  instructions[0x03] = (instruction_t){"INC BC", instruction_inc_bc};
  instructions[0x04] = (instruction_t){"INC B", instruction_inc_b};
  instructions[0x05] = (instruction_t){"DEC B", instruction_dec_b};
  instructions[0x06] = (instruction_t){"LD B, n8", instruction_ld_b_n8};
  instructions[0x07] = (instruction_t){"RLCA", instruction_rlca};
  instructions[0x08] =
      (instruction_t){"LD (a16), SP", instruction_ld_deref_a16_sp};
  instructions[0x09] = (instruction_t){"ADD HL, BC", instruction_add_hl_bc};
  instructions[0x0A] = (instruction_t){"LD A, (BC)", instruction_ld_a_deref_bc};
  instructions[0x0B] = (instruction_t){"DEC BC", instruction_dec_bc};
  instructions[0x0C] = (instruction_t){"INC C", instruction_inc_c};
  instructions[0x0D] = (instruction_t){"DEC C", instruction_dec_c};
  instructions[0x0E] = (instruction_t){"LD C, n8", instruction_ld_c_n8};
  instructions[0x0F] = (instruction_t){"RRCA", instruction_rrca};
  instructions[0x10] = (instruction_t){"STOP n8", instruction_stop_n8};
  instructions[0x11] = (instruction_t){"LD DE, n16", instruction_ld_de_n16};
  instructions[0x12] = (instruction_t){"LD (DE), A", instruction_ld_deref_de_a};
  instructions[0x13] = (instruction_t){"INC DE", instruction_inc_de};
  instructions[0x14] = (instruction_t){"INC D", instruction_inc_d};
  instructions[0x15] = (instruction_t){"DEC D", instruction_dec_d};
  instructions[0x16] = (instruction_t){"LD D, n8", instruction_ld_d_n8};
  instructions[0x17] = (instruction_t){"RLA", instruction_rla};
  instructions[0x18] = (instruction_t){"JR e8", instruction_jr_e8};
  instructions[0x19] = (instruction_t){"ADD HL, DE", instruction_add_hl_de};
  instructions[0x1A] = (instruction_t){"LD A, (DE)", instruction_ld_a_deref_de};
  instructions[0x1B] = (instruction_t){"DEC DE", instruction_dec_de};
  instructions[0x1C] = (instruction_t){"INC E", instruction_inc_e};
  instructions[0x1D] = (instruction_t){"DEC E", instruction_dec_e};
  instructions[0x1E] = (instruction_t){"LD E, n8", instruction_ld_e_n8};
  instructions[0x1F] = (instruction_t){"RRA", instruction_rra};
  instructions[0x20] = (instruction_t){"JR NZ, e8", instruction_jr_nz_e8};
  instructions[0x21] = (instruction_t){"LD HL, n16", instruction_ld_hl_n16};
  instructions[0x22] =
      (instruction_t){"LD (HL+), A", instruction_ld_inc_deref_hl_a};
  instructions[0x23] = (instruction_t){"INC HL", instruction_inc_hl};
  instructions[0x24] = (instruction_t){"INC H", instruction_inc_h};
  instructions[0x25] = (instruction_t){"DEC H", instruction_dec_h};
  instructions[0x26] = (instruction_t){"LD H, n8", instruction_ld_h_n8};
  instructions[0x27] = (instruction_t){"DAA", instruction_daa};
  instructions[0x28] = (instruction_t){"JR Z, e8", instruction_jr_z_e8};
  instructions[0x29] = (instruction_t){"ADD HL, HL", instruction_add_hl_hl};
  instructions[0x2A] =
      (instruction_t){"LD A, (HL+)", instruction_ld_a_inc_deref_hl};
  instructions[0x2B] = (instruction_t){"DEC HL", instruction_dec_hl};
  instructions[0x2C] = (instruction_t){"INC L", instruction_inc_l};
  instructions[0x2D] = (instruction_t){"DEC L", instruction_dec_l};
  instructions[0x2E] = (instruction_t){"LD L, n8", instruction_ld_l_n8};
  instructions[0x2F] = (instruction_t){"CPL", instruction_cpl};
  instructions[0x30] = (instruction_t){"JR NC, e8", instruction_jr_nc_e8};
  instructions[0x31] = (instruction_t){"LD SP, n16", instruction_ld_sp_n16};
  instructions[0x32] =
      (instruction_t){"LD (HL-), A", instruction_ld_dec_deref_hl_a};
  instructions[0x33] = (instruction_t){"INC SP", instruction_inc_sp};
  instructions[0x34] = (instruction_t){"INC (HL)", instruction_inc_deref_hl};
  instructions[0x35] = (instruction_t){"DEC (HL)", instruction_dec_deref_hl};
  instructions[0x36] =
      (instruction_t){"LD (HL), n8", instruction_ld_deref_hl_n8};
  instructions[0x37] = (instruction_t){"SCF", instruction_scf};
  instructions[0x38] = (instruction_t){"JR C, e8", instruction_jr_c_e8};
  instructions[0x39] = (instruction_t){"ADD HL, SP", instruction_add_hl_sp};
  instructions[0x3A] =
      (instruction_t){"LD A, (HL-)", instruction_ld_a_dec_deref_hl};
  instructions[0x3B] = (instruction_t){"DEC SP", instruction_dec_sp};
  instructions[0x3C] = (instruction_t){"INC A", instruction_inc_a};
  instructions[0x3D] = (instruction_t){"DEC A", instruction_dec_a};
  instructions[0x3E] = (instruction_t){"LD A, n8", instruction_ld_a_n8};
  instructions[0x3F] = (instruction_t){"CCF", instruction_ccf};
  instructions[0x40] = (instruction_t){"LD B, B", instruction_ld_b_b};
  instructions[0x41] = (instruction_t){"LD B, C", instruction_ld_b_c};
  instructions[0x42] = (instruction_t){"LD B, D", instruction_ld_b_d};
  instructions[0x43] = (instruction_t){"LD B, E", instruction_ld_b_e};
  instructions[0x44] = (instruction_t){"LD B, H", instruction_ld_b_h};
  instructions[0x45] = (instruction_t){"LD B, L", instruction_ld_b_l};
  instructions[0x46] = (instruction_t){"LD B, (HL)", instruction_ld_b_deref_hl};
  instructions[0x47] = (instruction_t){"LD B, A", instruction_ld_b_a};
  instructions[0x48] = (instruction_t){"LD C, B", instruction_ld_c_b};
  instructions[0x49] = (instruction_t){"LD C, C", instruction_ld_c_c};
  instructions[0x4A] = (instruction_t){"LD C, D", instruction_ld_c_d};
  instructions[0x4B] = (instruction_t){"LD C, E", instruction_ld_c_e};
  instructions[0x4C] = (instruction_t){"LD C, H", instruction_ld_c_h};
  instructions[0x4D] = (instruction_t){"LD C, L", instruction_ld_c_l};
  instructions[0x4E] = (instruction_t){"LD C, (HL)", instruction_ld_c_deref_hl};
  instructions[0x4F] = (instruction_t){"LD C, A", instruction_ld_c_a};
  instructions[0x50] = (instruction_t){"LD D, B", instruction_ld_d_b};
  instructions[0x51] = (instruction_t){"LD D, C", instruction_ld_d_c};
  instructions[0x52] = (instruction_t){"LD D, D", instruction_ld_d_d};
  instructions[0x53] = (instruction_t){"LD D, E", instruction_ld_d_e};
  instructions[0x54] = (instruction_t){"LD D, H", instruction_ld_d_h};
  instructions[0x55] = (instruction_t){"LD D, L", instruction_ld_d_l};
  instructions[0x56] = (instruction_t){"LD D, (HL)", instruction_ld_d_deref_hl};
  instructions[0x57] = (instruction_t){"LD D, A", instruction_ld_d_a};
  instructions[0x58] = (instruction_t){"LD E, B", instruction_ld_e_b};
  instructions[0x59] = (instruction_t){"LD E, C", instruction_ld_e_c};
  instructions[0x5A] = (instruction_t){"LD E, D", instruction_ld_e_d};
  instructions[0x5B] = (instruction_t){"LD E, E", instruction_ld_e_e};
  instructions[0x5C] = (instruction_t){"LD E, H", instruction_ld_e_h};
  instructions[0x5D] = (instruction_t){"LD E, L", instruction_ld_e_l};
  instructions[0x5E] = (instruction_t){"LD E, (HL)", instruction_ld_e_deref_hl};
  instructions[0x5F] = (instruction_t){"LD E, A", instruction_ld_e_a};
  instructions[0x60] = (instruction_t){"LD H, B", instruction_ld_h_b};
  instructions[0x61] = (instruction_t){"LD H, C", instruction_ld_h_c};
  instructions[0x62] = (instruction_t){"LD H, D", instruction_ld_h_d};
  instructions[0x63] = (instruction_t){"LD H, E", instruction_ld_h_e};
  instructions[0x64] = (instruction_t){"LD H, H", instruction_ld_h_h};
  instructions[0x65] = (instruction_t){"LD H, L", instruction_ld_h_l};
  instructions[0x66] = (instruction_t){"LD H, (HL)", instruction_ld_h_deref_hl};
  instructions[0x67] = (instruction_t){"LD H, A", instruction_ld_h_a};
  instructions[0x68] = (instruction_t){"LD L, B", instruction_ld_l_b};
  instructions[0x69] = (instruction_t){"LD L, C", instruction_ld_l_c};
  instructions[0x6A] = (instruction_t){"LD L, D", instruction_ld_l_d};
  instructions[0x6B] = (instruction_t){"LD L, E", instruction_ld_l_e};
  instructions[0x6C] = (instruction_t){"LD L, H", instruction_ld_l_h};
  instructions[0x6D] = (instruction_t){"LD L, L", instruction_ld_l_l};
  instructions[0x6E] = (instruction_t){"LD L, (HL)", instruction_ld_l_deref_hl};
  instructions[0x6F] = (instruction_t){"LD L, A", instruction_ld_l_a};
  instructions[0x70] = (instruction_t){"LD (HL), B", instruction_ld_deref_hl_b};
  instructions[0x71] = (instruction_t){"LD (HL), C", instruction_ld_deref_hl_c};
  instructions[0x72] = (instruction_t){"LD (HL), D", instruction_ld_deref_hl_d};
  instructions[0x73] = (instruction_t){"LD (HL), E", instruction_ld_deref_hl_e};
  instructions[0x74] = (instruction_t){"LD (HL), H", instruction_ld_deref_hl_h};
  instructions[0x75] = (instruction_t){"LD (HL), L", instruction_ld_deref_hl_l};
  instructions[0x76] = (instruction_t){"HALT", instruction_halt};
  instructions[0x77] = (instruction_t){"LD (HL), A", instruction_ld_deref_hl_a};
  instructions[0x78] = (instruction_t){"LD A, B", instruction_ld_a_b};
  instructions[0x79] = (instruction_t){"LD A, C", instruction_ld_a_c};
  instructions[0x7A] = (instruction_t){"LD A, D", instruction_ld_a_d};
  instructions[0x7B] = (instruction_t){"LD A, E", instruction_ld_a_e};
  instructions[0x7C] = (instruction_t){"LD A, H", instruction_ld_a_h};
  instructions[0x7D] = (instruction_t){"LD A, L", instruction_ld_a_l};
  instructions[0x7E] = (instruction_t){"LD A, (HL)", instruction_ld_a_deref_hl};
  instructions[0x7F] = (instruction_t){"LD A, A", instruction_ld_a_a};
  instructions[0x80] = (instruction_t){"ADD A, B", instruction_add_a_b};
  instructions[0x81] = (instruction_t){"ADD A, C", instruction_add_a_c};
  instructions[0x82] = (instruction_t){"ADD A, D", instruction_add_a_d};
  instructions[0x83] = (instruction_t){"ADD A, E", instruction_add_a_e};
  instructions[0x84] = (instruction_t){"ADD A, H", instruction_add_a_h};
  instructions[0x85] = (instruction_t){"ADD A, L", instruction_add_a_l};
  instructions[0x86] =
      (instruction_t){"ADD A, (HL)", instruction_add_a_deref_hl};
  instructions[0x87] = (instruction_t){"ADD A, A", instruction_add_a_a};
  instructions[0x88] = (instruction_t){"ADC A, B", instruction_adc_a_b};
  instructions[0x89] = (instruction_t){"ADC A, C", instruction_adc_a_c};
  instructions[0x8A] = (instruction_t){"ADC A, D", instruction_adc_a_d};
  instructions[0x8B] = (instruction_t){"ADC A, E", instruction_adc_a_e};
  instructions[0x8C] = (instruction_t){"ADC A, H", instruction_adc_a_h};
  instructions[0x8D] = (instruction_t){"ADC A, L", instruction_adc_a_l};
  instructions[0x8E] =
      (instruction_t){"ADC A, (HL)", instruction_adc_a_deref_hl};
  instructions[0x8F] = (instruction_t){"ADC A, A", instruction_adc_a_a};
  instructions[0x90] = (instruction_t){"SUB A, B", instruction_sub_a_b};
  instructions[0x91] = (instruction_t){"SUB A, C", instruction_sub_a_c};
  instructions[0x92] = (instruction_t){"SUB A, D", instruction_sub_a_d};
  instructions[0x93] = (instruction_t){"SUB A, E", instruction_sub_a_e};
  instructions[0x94] = (instruction_t){"SUB A, H", instruction_sub_a_h};
  instructions[0x95] = (instruction_t){"SUB A, L", instruction_sub_a_l};
  instructions[0x96] =
      (instruction_t){"SUB A, (HL)", instruction_sub_a_deref_hl};
  instructions[0x97] = (instruction_t){"SUB A, A", instruction_sub_a_a};
  instructions[0x98] = (instruction_t){"SBC A, B", instruction_sbc_a_b};
  instructions[0x99] = (instruction_t){"SBC A, C", instruction_sbc_a_c};
  instructions[0x9A] = (instruction_t){"SBC A, D", instruction_sbc_a_d};
  instructions[0x9B] = (instruction_t){"SBC A, E", instruction_sbc_a_e};
  instructions[0x9C] = (instruction_t){"SBC A, H", instruction_sbc_a_h};
  instructions[0x9D] = (instruction_t){"SBC A, L", instruction_sbc_a_l};
  instructions[0x9E] =
      (instruction_t){"SBC A, (HL)", instruction_sbc_a_deref_hl};
  instructions[0x9F] = (instruction_t){"SBC A, A", instruction_sbc_a_a};
  instructions[0xA0] = (instruction_t){"AND A, B", instruction_and_a_b};
  instructions[0xA1] = (instruction_t){"AND A, C", instruction_and_a_c};
  instructions[0xA2] = (instruction_t){"AND A, D", instruction_and_a_d};
  instructions[0xA3] = (instruction_t){"AND A, E", instruction_and_a_e};
  instructions[0xA4] = (instruction_t){"AND A, H", instruction_and_a_h};
  instructions[0xA5] = (instruction_t){"AND A, L", instruction_and_a_l};
  instructions[0xA6] =
      (instruction_t){"AND A, (HL)", instruction_and_a_deref_hl};
  instructions[0xA7] = (instruction_t){"AND A, A", instruction_and_a_a};
  instructions[0xA8] = (instruction_t){"XOR A, B", instruction_xor_a_b};
  instructions[0xA9] = (instruction_t){"XOR A, C", instruction_xor_a_c};
  instructions[0xAA] = (instruction_t){"XOR A, D", instruction_xor_a_d};
  instructions[0xAB] = (instruction_t){"XOR A, E", instruction_xor_a_e};
  instructions[0xAC] = (instruction_t){"XOR A, H", instruction_xor_a_h};
  instructions[0xAD] = (instruction_t){"XOR A, L", instruction_xor_a_l};
  instructions[0xAE] =
      (instruction_t){"XOR A, (HL)", instruction_xor_a_deref_hl};
  instructions[0xAF] = (instruction_t){"XOR A, A", instruction_xor_a_a};
  instructions[0xB0] = (instruction_t){"OR A, B", instruction_or_a_b};
  instructions[0xB1] = (instruction_t){"OR A, C", instruction_or_a_c};
  instructions[0xB2] = (instruction_t){"OR A, D", instruction_or_a_d};
  instructions[0xB3] = (instruction_t){"OR A, E", instruction_or_a_e};
  instructions[0xB4] = (instruction_t){"OR A, H", instruction_or_a_h};
  instructions[0xB5] = (instruction_t){"OR A, L", instruction_or_a_l};
  instructions[0xB6] = (instruction_t){"OR A, (HL)", instruction_or_a_deref_hl};
  instructions[0xB7] = (instruction_t){"OR A, A", instruction_or_a_a};
  instructions[0xB8] = (instruction_t){"CP A, B", instruction_cp_a_b};
  instructions[0xB9] = (instruction_t){"CP A, C", instruction_cp_a_c};
  instructions[0xBA] = (instruction_t){"CP A, D", instruction_cp_a_d};
  instructions[0xBB] = (instruction_t){"CP A, E", instruction_cp_a_e};
  instructions[0xBC] = (instruction_t){"CP A, H", instruction_cp_a_h};
  instructions[0xBD] = (instruction_t){"CP A, L", instruction_cp_a_l};
  instructions[0xBE] = (instruction_t){"CP A, (HL)", instruction_cp_a_deref_hl};
  instructions[0xBF] = (instruction_t){"CP A, A", instruction_cp_a_a};
  instructions[0xC0] = (instruction_t){"RET NZ", instruction_ret_nz};
  instructions[0xC1] = (instruction_t){"POP BC", instruction_pop_bc};
  instructions[0xC2] = (instruction_t){"JP NZ, a16", instruction_jp_nz_a16};
  instructions[0xC3] = (instruction_t){"JP a16", instruction_jp_a16};
  instructions[0xC4] = (instruction_t){"CALL NZ, a16", instruction_call_nz_a16};
  instructions[0xC5] = (instruction_t){"PUSH BC", instruction_push_bc};
  instructions[0xC6] = (instruction_t){"ADD A, n8", instruction_add_a_n8};
  instructions[0xC7] = (instruction_t){"RST $00", instruction_rst_00};
  instructions[0xC8] = (instruction_t){"RET Z", instruction_ret_z};
  instructions[0xC9] = (instruction_t){"RET", instruction_ret};
  instructions[0xCA] = (instruction_t){"JP Z, a16", instruction_jp_z_a16};
  instructions[0xCB] = (instruction_t){"PREFIX", instruction_prefix};
  instructions[0xCC] = (instruction_t){"CALL Z, a16", instruction_call_z_a16};
  instructions[0xCD] = (instruction_t){"CALL a16", instruction_call_a16};
  instructions[0xCE] = (instruction_t){"ADC A, n8", instruction_adc_a_n8};
  instructions[0xCF] = (instruction_t){"RST $08", instruction_rst_08};
  instructions[0xD0] = (instruction_t){"RET NC", instruction_ret_nc};
  instructions[0xD1] = (instruction_t){"POP DE", instruction_pop_de};
  instructions[0xD2] = (instruction_t){"JP NC, a16", instruction_jp_nc_a16};
  instructions[0xD3] = (instruction_t){"ILLEGAL_D3", instruction_illegal_d3};
  instructions[0xD4] = (instruction_t){"CALL NC, a16", instruction_call_nc_a16};
  instructions[0xD5] = (instruction_t){"PUSH DE", instruction_push_de};
  instructions[0xD6] = (instruction_t){"SUB A, n8", instruction_sub_a_n8};
  instructions[0xD7] = (instruction_t){"RST $10", instruction_rst_10};
  instructions[0xD8] = (instruction_t){"RET C", instruction_ret_c};
  instructions[0xD9] = (instruction_t){"RETI", instruction_reti};
  instructions[0xDA] = (instruction_t){"JP C, a16", instruction_jp_c_a16};
  instructions[0xDB] = (instruction_t){"ILLEGAL_DB", instruction_illegal_db};
  instructions[0xDC] = (instruction_t){"CALL C, a16", instruction_call_c_a16};
  instructions[0xDD] = (instruction_t){"ILLEGAL_DD", instruction_illegal_dd};
  instructions[0xDE] = (instruction_t){"SBC A, n8", instruction_sbc_a_n8};
  instructions[0xDF] = (instruction_t){"RST $18", instruction_rst_18};
  instructions[0xE0] =
      (instruction_t){"LDH (a8), A", instruction_ldh_deref_a8_a};
  instructions[0xE1] = (instruction_t){"POP HL", instruction_pop_hl};
  instructions[0xE2] = (instruction_t){"LDH (C), A", instruction_ldh_deref_c_a};
  instructions[0xE3] = (instruction_t){"ILLEGAL_E3", instruction_illegal_e3};
  instructions[0xE4] = (instruction_t){"ILLEGAL_E4", instruction_illegal_e4};
  instructions[0xE5] = (instruction_t){"PUSH HL", instruction_push_hl};
  instructions[0xE6] = (instruction_t){"AND A, n8", instruction_and_a_n8};
  instructions[0xE7] = (instruction_t){"RST $20", instruction_rst_20};
  instructions[0xE8] = (instruction_t){"ADD SP, e8", instruction_add_sp_e8};
  instructions[0xE9] = (instruction_t){"JP HL", instruction_jp_hl};
  instructions[0xEA] =
      (instruction_t){"LD (a16), A", instruction_ld_deref_a16_a};
  instructions[0xEB] = (instruction_t){"ILLEGAL_EB", instruction_illegal_eb};
  instructions[0xEC] = (instruction_t){"ILLEGAL_EC", instruction_illegal_ec};
  instructions[0xED] = (instruction_t){"ILLEGAL_ED", instruction_illegal_ed};
  instructions[0xEE] = (instruction_t){"XOR A, n8", instruction_xor_a_n8};
  instructions[0xEF] = (instruction_t){"RST $28", instruction_rst_28};
  instructions[0xF0] =
      (instruction_t){"LDH A, (a8)", instruction_ldh_a_deref_a8};
  instructions[0xF1] = (instruction_t){"POP AF", instruction_pop_af};
  instructions[0xF2] = (instruction_t){"LDH A, (C)", instruction_ldh_a_deref_c};
  instructions[0xF3] = (instruction_t){"DI", instruction_di};
  instructions[0xF4] = (instruction_t){"ILLEGAL_F4", instruction_illegal_f4};
  instructions[0xF5] = (instruction_t){"PUSH AF", instruction_push_af};
  instructions[0xF6] = (instruction_t){"OR A, n8", instruction_or_a_n8};
  instructions[0xF7] = (instruction_t){"RST $30", instruction_rst_30};
  instructions[0xF8] =
      (instruction_t){"LD HL, SP+, e8", instruction_ld_hl_inc_sp_e8};
  instructions[0xF9] = (instruction_t){"LD SP, HL", instruction_ld_sp_hl};
  instructions[0xFA] =
      (instruction_t){"LD A, (a16)", instruction_ld_a_deref_a16};
  instructions[0xFB] = (instruction_t){"EI", instruction_ei};
  instructions[0xFC] = (instruction_t){"ILLEGAL_FC", instruction_illegal_fc};
  instructions[0xFD] = (instruction_t){"ILLEGAL_FD", instruction_illegal_fd};
  instructions[0xFE] = (instruction_t){"CP A, n8", instruction_cp_a_n8};
  instructions[0xFF] = (instruction_t){"RST $38", instruction_rst_38};
};

instruction_t extended_instructions[256];

void extended_instructions_init() {
  extended_instructions[0x00] = (instruction_t){"RLC B", instruction_rlc_b};
  extended_instructions[0x01] = (instruction_t){"RLC C", instruction_rlc_c};
  extended_instructions[0x02] = (instruction_t){"RLC D", instruction_rlc_d};
  extended_instructions[0x03] = (instruction_t){"RLC E", instruction_rlc_e};
  extended_instructions[0x04] = (instruction_t){"RLC H", instruction_rlc_h};
  extended_instructions[0x05] = (instruction_t){"RLC L", instruction_rlc_l};
  extended_instructions[0x06] =
      (instruction_t){"RLC (HL)", instruction_rlc_deref_hl};
  extended_instructions[0x07] = (instruction_t){"RLC A", instruction_rlc_a};
  extended_instructions[0x08] = (instruction_t){"RRC B", instruction_rrc_b};
  extended_instructions[0x09] = (instruction_t){"RRC C", instruction_rrc_c};
  extended_instructions[0x0A] = (instruction_t){"RRC D", instruction_rrc_d};
  extended_instructions[0x0B] = (instruction_t){"RRC E", instruction_rrc_e};
  extended_instructions[0x0C] = (instruction_t){"RRC H", instruction_rrc_h};
  extended_instructions[0x0D] = (instruction_t){"RRC L", instruction_rrc_l};
  extended_instructions[0x0E] =
      (instruction_t){"RRC (HL)", instruction_rrc_deref_hl};
  extended_instructions[0x0F] = (instruction_t){"RRC A", instruction_rrc_a};
  extended_instructions[0x10] = (instruction_t){"RL B", instruction_rl_b};
  extended_instructions[0x11] = (instruction_t){"RL C", instruction_rl_c};
  extended_instructions[0x12] = (instruction_t){"RL D", instruction_rl_d};
  extended_instructions[0x13] = (instruction_t){"RL E", instruction_rl_e};
  extended_instructions[0x14] = (instruction_t){"RL H", instruction_rl_h};
  extended_instructions[0x15] = (instruction_t){"RL L", instruction_rl_l};
  extended_instructions[0x16] =
      (instruction_t){"RL (HL)", instruction_rl_deref_hl};
  extended_instructions[0x17] = (instruction_t){"RL A", instruction_rl_a};
  extended_instructions[0x18] = (instruction_t){"RR B", instruction_rr_b};
  extended_instructions[0x19] = (instruction_t){"RR C", instruction_rr_c};
  extended_instructions[0x1A] = (instruction_t){"RR D", instruction_rr_d};
  extended_instructions[0x1B] = (instruction_t){"RR E", instruction_rr_e};
  extended_instructions[0x1C] = (instruction_t){"RR H", instruction_rr_h};
  extended_instructions[0x1D] = (instruction_t){"RR L", instruction_rr_l};
  extended_instructions[0x1E] =
      (instruction_t){"RR (HL)", instruction_rr_deref_hl};
  extended_instructions[0x1F] = (instruction_t){"RR A", instruction_rr_a};
  extended_instructions[0x20] = (instruction_t){"SLA B", instruction_sla_b};
  extended_instructions[0x21] = (instruction_t){"SLA C", instruction_sla_c};
  extended_instructions[0x22] = (instruction_t){"SLA D", instruction_sla_d};
  extended_instructions[0x23] = (instruction_t){"SLA E", instruction_sla_e};
  extended_instructions[0x24] = (instruction_t){"SLA H", instruction_sla_h};
  extended_instructions[0x25] = (instruction_t){"SLA L", instruction_sla_l};
  extended_instructions[0x26] =
      (instruction_t){"SLA (HL)", instruction_sla_deref_hl};
  extended_instructions[0x27] = (instruction_t){"SLA A", instruction_sla_a};
  extended_instructions[0x28] = (instruction_t){"SRA B", instruction_sra_b};
  extended_instructions[0x29] = (instruction_t){"SRA C", instruction_sra_c};
  extended_instructions[0x2A] = (instruction_t){"SRA D", instruction_sra_d};
  extended_instructions[0x2B] = (instruction_t){"SRA E", instruction_sra_e};
  extended_instructions[0x2C] = (instruction_t){"SRA H", instruction_sra_h};
  extended_instructions[0x2D] = (instruction_t){"SRA L", instruction_sra_l};
  extended_instructions[0x2E] =
      (instruction_t){"SRA (HL)", instruction_sra_deref_hl};
  extended_instructions[0x2F] = (instruction_t){"SRA A", instruction_sra_a};
  extended_instructions[0x30] = (instruction_t){"SWAP B", instruction_swap_b};
  extended_instructions[0x31] = (instruction_t){"SWAP C", instruction_swap_c};
  extended_instructions[0x32] = (instruction_t){"SWAP D", instruction_swap_d};
  extended_instructions[0x33] = (instruction_t){"SWAP E", instruction_swap_e};
  extended_instructions[0x34] = (instruction_t){"SWAP H", instruction_swap_h};
  extended_instructions[0x35] = (instruction_t){"SWAP L", instruction_swap_l};
  extended_instructions[0x36] =
      (instruction_t){"SWAP (HL)", instruction_swap_deref_hl};
  extended_instructions[0x37] = (instruction_t){"SWAP A", instruction_swap_a};
  extended_instructions[0x38] = (instruction_t){"SRL B", instruction_srl_b};
  extended_instructions[0x39] = (instruction_t){"SRL C", instruction_srl_c};
  extended_instructions[0x3A] = (instruction_t){"SRL D", instruction_srl_d};
  extended_instructions[0x3B] = (instruction_t){"SRL E", instruction_srl_e};
  extended_instructions[0x3C] = (instruction_t){"SRL H", instruction_srl_h};
  extended_instructions[0x3D] = (instruction_t){"SRL L", instruction_srl_l};
  extended_instructions[0x3E] =
      (instruction_t){"SRL (HL)", instruction_srl_deref_hl};
  extended_instructions[0x3F] = (instruction_t){"SRL A", instruction_srl_a};
  extended_instructions[0x40] =
      (instruction_t){"BIT 0, B", instruction_bit_0_b};
  extended_instructions[0x41] =
      (instruction_t){"BIT 0, C", instruction_bit_0_c};
  extended_instructions[0x42] =
      (instruction_t){"BIT 0, D", instruction_bit_0_d};
  extended_instructions[0x43] =
      (instruction_t){"BIT 0, E", instruction_bit_0_e};
  extended_instructions[0x44] =
      (instruction_t){"BIT 0, H", instruction_bit_0_h};
  extended_instructions[0x45] =
      (instruction_t){"BIT 0, L", instruction_bit_0_l};
  extended_instructions[0x46] =
      (instruction_t){"BIT 0, (HL)", instruction_bit_0_deref_hl};
  extended_instructions[0x47] =
      (instruction_t){"BIT 0, A", instruction_bit_0_a};
  extended_instructions[0x48] =
      (instruction_t){"BIT 1, B", instruction_bit_1_b};
  extended_instructions[0x49] =
      (instruction_t){"BIT 1, C", instruction_bit_1_c};
  extended_instructions[0x4A] =
      (instruction_t){"BIT 1, D", instruction_bit_1_d};
  extended_instructions[0x4B] =
      (instruction_t){"BIT 1, E", instruction_bit_1_e};
  extended_instructions[0x4C] =
      (instruction_t){"BIT 1, H", instruction_bit_1_h};
  extended_instructions[0x4D] =
      (instruction_t){"BIT 1, L", instruction_bit_1_l};
  extended_instructions[0x4E] =
      (instruction_t){"BIT 1, (HL)", instruction_bit_1_deref_hl};
  extended_instructions[0x4F] =
      (instruction_t){"BIT 1, A", instruction_bit_1_a};
  extended_instructions[0x50] =
      (instruction_t){"BIT 2, B", instruction_bit_2_b};
  extended_instructions[0x51] =
      (instruction_t){"BIT 2, C", instruction_bit_2_c};
  extended_instructions[0x52] =
      (instruction_t){"BIT 2, D", instruction_bit_2_d};
  extended_instructions[0x53] =
      (instruction_t){"BIT 2, E", instruction_bit_2_e};
  extended_instructions[0x54] =
      (instruction_t){"BIT 2, H", instruction_bit_2_h};
  extended_instructions[0x55] =
      (instruction_t){"BIT 2, L", instruction_bit_2_l};
  extended_instructions[0x56] =
      (instruction_t){"BIT 2, (HL)", instruction_bit_2_deref_hl};
  extended_instructions[0x57] =
      (instruction_t){"BIT 2, A", instruction_bit_2_a};
  extended_instructions[0x58] =
      (instruction_t){"BIT 3, B", instruction_bit_3_b};
  extended_instructions[0x59] =
      (instruction_t){"BIT 3, C", instruction_bit_3_c};
  extended_instructions[0x5A] =
      (instruction_t){"BIT 3, D", instruction_bit_3_d};
  extended_instructions[0x5B] =
      (instruction_t){"BIT 3, E", instruction_bit_3_e};
  extended_instructions[0x5C] =
      (instruction_t){"BIT 3, H", instruction_bit_3_h};
  extended_instructions[0x5D] =
      (instruction_t){"BIT 3, L", instruction_bit_3_l};
  extended_instructions[0x5E] =
      (instruction_t){"BIT 3, (HL)", instruction_bit_3_deref_hl};
  extended_instructions[0x5F] =
      (instruction_t){"BIT 3, A", instruction_bit_3_a};
  extended_instructions[0x60] =
      (instruction_t){"BIT 4, B", instruction_bit_4_b};
  extended_instructions[0x61] =
      (instruction_t){"BIT 4, C", instruction_bit_4_c};
  extended_instructions[0x62] =
      (instruction_t){"BIT 4, D", instruction_bit_4_d};
  extended_instructions[0x63] =
      (instruction_t){"BIT 4, E", instruction_bit_4_e};
  extended_instructions[0x64] =
      (instruction_t){"BIT 4, H", instruction_bit_4_h};
  extended_instructions[0x65] =
      (instruction_t){"BIT 4, L", instruction_bit_4_l};
  extended_instructions[0x66] =
      (instruction_t){"BIT 4, (HL)", instruction_bit_4_deref_hl};
  extended_instructions[0x67] =
      (instruction_t){"BIT 4, A", instruction_bit_4_a};
  extended_instructions[0x68] =
      (instruction_t){"BIT 5, B", instruction_bit_5_b};
  extended_instructions[0x69] =
      (instruction_t){"BIT 5, C", instruction_bit_5_c};
  extended_instructions[0x6A] =
      (instruction_t){"BIT 5, D", instruction_bit_5_d};
  extended_instructions[0x6B] =
      (instruction_t){"BIT 5, E", instruction_bit_5_e};
  extended_instructions[0x6C] =
      (instruction_t){"BIT 5, H", instruction_bit_5_h};
  extended_instructions[0x6D] =
      (instruction_t){"BIT 5, L", instruction_bit_5_l};
  extended_instructions[0x6E] =
      (instruction_t){"BIT 5, (HL)", instruction_bit_5_deref_hl};
  extended_instructions[0x6F] =
      (instruction_t){"BIT 5, A", instruction_bit_5_a};
  extended_instructions[0x70] =
      (instruction_t){"BIT 6, B", instruction_bit_6_b};
  extended_instructions[0x71] =
      (instruction_t){"BIT 6, C", instruction_bit_6_c};
  extended_instructions[0x72] =
      (instruction_t){"BIT 6, D", instruction_bit_6_d};
  extended_instructions[0x73] =
      (instruction_t){"BIT 6, E", instruction_bit_6_e};
  extended_instructions[0x74] =
      (instruction_t){"BIT 6, H", instruction_bit_6_h};
  extended_instructions[0x75] =
      (instruction_t){"BIT 6, L", instruction_bit_6_l};
  extended_instructions[0x76] =
      (instruction_t){"BIT 6, (HL)", instruction_bit_6_deref_hl};
  extended_instructions[0x77] =
      (instruction_t){"BIT 6, A", instruction_bit_6_a};
  extended_instructions[0x78] =
      (instruction_t){"BIT 7, B", instruction_bit_7_b};
  extended_instructions[0x79] =
      (instruction_t){"BIT 7, C", instruction_bit_7_c};
  extended_instructions[0x7A] =
      (instruction_t){"BIT 7, D", instruction_bit_7_d};
  extended_instructions[0x7B] =
      (instruction_t){"BIT 7, E", instruction_bit_7_e};
  extended_instructions[0x7C] =
      (instruction_t){"BIT 7, H", instruction_bit_7_h};
  extended_instructions[0x7D] =
      (instruction_t){"BIT 7, L", instruction_bit_7_l};
  extended_instructions[0x7E] =
      (instruction_t){"BIT 7, (HL)", instruction_bit_7_deref_hl};
  extended_instructions[0x7F] =
      (instruction_t){"BIT 7, A", instruction_bit_7_a};
  extended_instructions[0x80] =
      (instruction_t){"RES 0, B", instruction_res_0_b};
  extended_instructions[0x81] =
      (instruction_t){"RES 0, C", instruction_res_0_c};
  extended_instructions[0x82] =
      (instruction_t){"RES 0, D", instruction_res_0_d};
  extended_instructions[0x83] =
      (instruction_t){"RES 0, E", instruction_res_0_e};
  extended_instructions[0x84] =
      (instruction_t){"RES 0, H", instruction_res_0_h};
  extended_instructions[0x85] =
      (instruction_t){"RES 0, L", instruction_res_0_l};
  extended_instructions[0x86] =
      (instruction_t){"RES 0, (HL)", instruction_res_0_deref_hl};
  extended_instructions[0x87] =
      (instruction_t){"RES 0, A", instruction_res_0_a};
  extended_instructions[0x88] =
      (instruction_t){"RES 1, B", instruction_res_1_b};
  extended_instructions[0x89] =
      (instruction_t){"RES 1, C", instruction_res_1_c};
  extended_instructions[0x8A] =
      (instruction_t){"RES 1, D", instruction_res_1_d};
  extended_instructions[0x8B] =
      (instruction_t){"RES 1, E", instruction_res_1_e};
  extended_instructions[0x8C] =
      (instruction_t){"RES 1, H", instruction_res_1_h};
  extended_instructions[0x8D] =
      (instruction_t){"RES 1, L", instruction_res_1_l};
  extended_instructions[0x8E] =
      (instruction_t){"RES 1, (HL)", instruction_res_1_deref_hl};
  extended_instructions[0x8F] =
      (instruction_t){"RES 1, A", instruction_res_1_a};
  extended_instructions[0x90] =
      (instruction_t){"RES 2, B", instruction_res_2_b};
  extended_instructions[0x91] =
      (instruction_t){"RES 2, C", instruction_res_2_c};
  extended_instructions[0x92] =
      (instruction_t){"RES 2, D", instruction_res_2_d};
  extended_instructions[0x93] =
      (instruction_t){"RES 2, E", instruction_res_2_e};
  extended_instructions[0x94] =
      (instruction_t){"RES 2, H", instruction_res_2_h};
  extended_instructions[0x95] =
      (instruction_t){"RES 2, L", instruction_res_2_l};
  extended_instructions[0x96] =
      (instruction_t){"RES 2, (HL)", instruction_res_2_deref_hl};
  extended_instructions[0x97] =
      (instruction_t){"RES 2, A", instruction_res_2_a};
  extended_instructions[0x98] =
      (instruction_t){"RES 3, B", instruction_res_3_b};
  extended_instructions[0x99] =
      (instruction_t){"RES 3, C", instruction_res_3_c};
  extended_instructions[0x9A] =
      (instruction_t){"RES 3, D", instruction_res_3_d};
  extended_instructions[0x9B] =
      (instruction_t){"RES 3, E", instruction_res_3_e};
  extended_instructions[0x9C] =
      (instruction_t){"RES 3, H", instruction_res_3_h};
  extended_instructions[0x9D] =
      (instruction_t){"RES 3, L", instruction_res_3_l};
  extended_instructions[0x9E] =
      (instruction_t){"RES 3, (HL)", instruction_res_3_deref_hl};
  extended_instructions[0x9F] =
      (instruction_t){"RES 3, A", instruction_res_3_a};
  extended_instructions[0xA0] =
      (instruction_t){"RES 4, B", instruction_res_4_b};
  extended_instructions[0xA1] =
      (instruction_t){"RES 4, C", instruction_res_4_c};
  extended_instructions[0xA2] =
      (instruction_t){"RES 4, D", instruction_res_4_d};
  extended_instructions[0xA3] =
      (instruction_t){"RES 4, E", instruction_res_4_e};
  extended_instructions[0xA4] =
      (instruction_t){"RES 4, H", instruction_res_4_h};
  extended_instructions[0xA5] =
      (instruction_t){"RES 4, L", instruction_res_4_l};
  extended_instructions[0xA6] =
      (instruction_t){"RES 4, (HL)", instruction_res_4_deref_hl};
  extended_instructions[0xA7] =
      (instruction_t){"RES 4, A", instruction_res_4_a};
  extended_instructions[0xA8] =
      (instruction_t){"RES 5, B", instruction_res_5_b};
  extended_instructions[0xA9] =
      (instruction_t){"RES 5, C", instruction_res_5_c};
  extended_instructions[0xAA] =
      (instruction_t){"RES 5, D", instruction_res_5_d};
  extended_instructions[0xAB] =
      (instruction_t){"RES 5, E", instruction_res_5_e};
  extended_instructions[0xAC] =
      (instruction_t){"RES 5, H", instruction_res_5_h};
  extended_instructions[0xAD] =
      (instruction_t){"RES 5, L", instruction_res_5_l};
  extended_instructions[0xAE] =
      (instruction_t){"RES 5, (HL)", instruction_res_5_deref_hl};
  extended_instructions[0xAF] =
      (instruction_t){"RES 5, A", instruction_res_5_a};
  extended_instructions[0xB0] =
      (instruction_t){"RES 6, B", instruction_res_6_b};
  extended_instructions[0xB1] =
      (instruction_t){"RES 6, C", instruction_res_6_c};
  extended_instructions[0xB2] =
      (instruction_t){"RES 6, D", instruction_res_6_d};
  extended_instructions[0xB3] =
      (instruction_t){"RES 6, E", instruction_res_6_e};
  extended_instructions[0xB4] =
      (instruction_t){"RES 6, H", instruction_res_6_h};
  extended_instructions[0xB5] =
      (instruction_t){"RES 6, L", instruction_res_6_l};
  extended_instructions[0xB6] =
      (instruction_t){"RES 6, (HL)", instruction_res_6_deref_hl};
  extended_instructions[0xB7] =
      (instruction_t){"RES 6, A", instruction_res_6_a};
  extended_instructions[0xB8] =
      (instruction_t){"RES 7, B", instruction_res_7_b};
  extended_instructions[0xB9] =
      (instruction_t){"RES 7, C", instruction_res_7_c};
  extended_instructions[0xBA] =
      (instruction_t){"RES 7, D", instruction_res_7_d};
  extended_instructions[0xBB] =
      (instruction_t){"RES 7, E", instruction_res_7_e};
  extended_instructions[0xBC] =
      (instruction_t){"RES 7, H", instruction_res_7_h};
  extended_instructions[0xBD] =
      (instruction_t){"RES 7, L", instruction_res_7_l};
  extended_instructions[0xBE] =
      (instruction_t){"RES 7, (HL)", instruction_res_7_deref_hl};
  extended_instructions[0xBF] =
      (instruction_t){"RES 7, A", instruction_res_7_a};
  extended_instructions[0xC0] =
      (instruction_t){"SET 0, B", instruction_set_0_b};
  extended_instructions[0xC1] =
      (instruction_t){"SET 0, C", instruction_set_0_c};
  extended_instructions[0xC2] =
      (instruction_t){"SET 0, D", instruction_set_0_d};
  extended_instructions[0xC3] =
      (instruction_t){"SET 0, E", instruction_set_0_e};
  extended_instructions[0xC4] =
      (instruction_t){"SET 0, H", instruction_set_0_h};
  extended_instructions[0xC5] =
      (instruction_t){"SET 0, L", instruction_set_0_l};
  extended_instructions[0xC6] =
      (instruction_t){"SET 0, (HL)", instruction_set_0_deref_hl};
  extended_instructions[0xC7] =
      (instruction_t){"SET 0, A", instruction_set_0_a};
  extended_instructions[0xC8] =
      (instruction_t){"SET 1, B", instruction_set_1_b};
  extended_instructions[0xC9] =
      (instruction_t){"SET 1, C", instruction_set_1_c};
  extended_instructions[0xCA] =
      (instruction_t){"SET 1, D", instruction_set_1_d};
  extended_instructions[0xCB] =
      (instruction_t){"SET 1, E", instruction_set_1_e};
  extended_instructions[0xCC] =
      (instruction_t){"SET 1, H", instruction_set_1_h};
  extended_instructions[0xCD] =
      (instruction_t){"SET 1, L", instruction_set_1_l};
  extended_instructions[0xCE] =
      (instruction_t){"SET 1, (HL)", instruction_set_1_deref_hl};
  extended_instructions[0xCF] =
      (instruction_t){"SET 1, A", instruction_set_1_a};
  extended_instructions[0xD0] =
      (instruction_t){"SET 2, B", instruction_set_2_b};
  extended_instructions[0xD1] =
      (instruction_t){"SET 2, C", instruction_set_2_c};
  extended_instructions[0xD2] =
      (instruction_t){"SET 2, D", instruction_set_2_d};
  extended_instructions[0xD3] =
      (instruction_t){"SET 2, E", instruction_set_2_e};
  extended_instructions[0xD4] =
      (instruction_t){"SET 2, H", instruction_set_2_h};
  extended_instructions[0xD5] =
      (instruction_t){"SET 2, L", instruction_set_2_l};
  extended_instructions[0xD6] =
      (instruction_t){"SET 2, (HL)", instruction_set_2_deref_hl};
  extended_instructions[0xD7] =
      (instruction_t){"SET 2, A", instruction_set_2_a};
  extended_instructions[0xD8] =
      (instruction_t){"SET 3, B", instruction_set_3_b};
  extended_instructions[0xD9] =
      (instruction_t){"SET 3, C", instruction_set_3_c};
  extended_instructions[0xDA] =
      (instruction_t){"SET 3, D", instruction_set_3_d};
  extended_instructions[0xDB] =
      (instruction_t){"SET 3, E", instruction_set_3_e};
  extended_instructions[0xDC] =
      (instruction_t){"SET 3, H", instruction_set_3_h};
  extended_instructions[0xDD] =
      (instruction_t){"SET 3, L", instruction_set_3_l};
  extended_instructions[0xDE] =
      (instruction_t){"SET 3, (HL)", instruction_set_3_deref_hl};
  extended_instructions[0xDF] =
      (instruction_t){"SET 3, A", instruction_set_3_a};
  extended_instructions[0xE0] =
      (instruction_t){"SET 4, B", instruction_set_4_b};
  extended_instructions[0xE1] =
      (instruction_t){"SET 4, C", instruction_set_4_c};
  extended_instructions[0xE2] =
      (instruction_t){"SET 4, D", instruction_set_4_d};
  extended_instructions[0xE3] =
      (instruction_t){"SET 4, E", instruction_set_4_e};
  extended_instructions[0xE4] =
      (instruction_t){"SET 4, H", instruction_set_4_h};
  extended_instructions[0xE5] =
      (instruction_t){"SET 4, L", instruction_set_4_l};
  extended_instructions[0xE6] =
      (instruction_t){"SET 4, (HL)", instruction_set_4_deref_hl};
  extended_instructions[0xE7] =
      (instruction_t){"SET 4, A", instruction_set_4_a};
  extended_instructions[0xE8] =
      (instruction_t){"SET 5, B", instruction_set_5_b};
  extended_instructions[0xE9] =
      (instruction_t){"SET 5, C", instruction_set_5_c};
  extended_instructions[0xEA] =
      (instruction_t){"SET 5, D", instruction_set_5_d};
  extended_instructions[0xEB] =
      (instruction_t){"SET 5, E", instruction_set_5_e};
  extended_instructions[0xEC] =
      (instruction_t){"SET 5, H", instruction_set_5_h};
  extended_instructions[0xED] =
      (instruction_t){"SET 5, L", instruction_set_5_l};
  extended_instructions[0xEE] =
      (instruction_t){"SET 5, (HL)", instruction_set_5_deref_hl};
  extended_instructions[0xEF] =
      (instruction_t){"SET 5, A", instruction_set_5_a};
  extended_instructions[0xF0] =
      (instruction_t){"SET 6, B", instruction_set_6_b};
  extended_instructions[0xF1] =
      (instruction_t){"SET 6, C", instruction_set_6_c};
  extended_instructions[0xF2] =
      (instruction_t){"SET 6, D", instruction_set_6_d};
  extended_instructions[0xF3] =
      (instruction_t){"SET 6, E", instruction_set_6_e};
  extended_instructions[0xF4] =
      (instruction_t){"SET 6, H", instruction_set_6_h};
  extended_instructions[0xF5] =
      (instruction_t){"SET 6, L", instruction_set_6_l};
  extended_instructions[0xF6] =
      (instruction_t){"SET 6, (HL)", instruction_set_6_deref_hl};
  extended_instructions[0xF7] =
      (instruction_t){"SET 6, A", instruction_set_6_a};
  extended_instructions[0xF8] =
      (instruction_t){"SET 7, B", instruction_set_7_b};
  extended_instructions[0xF9] =
      (instruction_t){"SET 7, C", instruction_set_7_c};
  extended_instructions[0xFA] =
      (instruction_t){"SET 7, D", instruction_set_7_d};
  extended_instructions[0xFB] =
      (instruction_t){"SET 7, E", instruction_set_7_e};
  extended_instructions[0xFC] =
      (instruction_t){"SET 7, H", instruction_set_7_h};
  extended_instructions[0xFD] =
      (instruction_t){"SET 7, L", instruction_set_7_l};
  extended_instructions[0xFE] =
      (instruction_t){"SET 7, (HL)", instruction_set_7_deref_hl};
  extended_instructions[0xFF] =
      (instruction_t){"SET 7, A", instruction_set_7_a};
};
