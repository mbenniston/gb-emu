...
#include <stdio.h>
int mbc_create(mbc_t *mbc, cartridge_type_e type, uint8_t *rom_data, uint32_t rom_size) {
    mbc->type = type;
    switch (type) {
        case ROM_ONLY:
        case MBC1:
        ...
        case MBC3_RAM_BATTERY:
            return mbc_mbc3_ram_battery_create(&mbc->mbc.mbc3_ram_battery, rom_data, rom_size);
        default:
            return 0;
    }
}
